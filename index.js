...
function validate(text) {
    // Se transforma a boolean(true or false) ya que match devuelve las mayusculas o si no null
...
function encrypt() {
    ...
    let encryptedText = textIn.value; //se accede al valor de la entrada

    if (validate(encryptedText) == true) {
        textIn.value = "Sólo se aceptan minúsculas y palabras sin acento";
        setTimeout(clean, 3000); //Ejecutar la función de limpiar luego de 3s
    }
    else {
